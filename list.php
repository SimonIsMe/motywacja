...
return [
    ...
    [
        'Jesteś jedyną osobą na świecie, <br />która może wykorzystać Twój potencjał.',
        'Zig Ziglar'
    ],
    [
        'Potykając się, można zajść daleko. <br />Nie wolno tylko upaść i nie podnieść się.',
        'Goethe'
    ],
    [
    ...
    [
        'Motywacja jest tym, co pozwala Ci zacząć.<br />Nawyk jest tym, co pozwala Ci wytrwać.',
        'Jim Ryun'
    ],
    [
        'W konfrontacji strumienia ze skałą, strumień zawsze wygrywa - <br />nie przez swoją siłę, ale przez wytrwałość.',
        'Budda'
    ],
    [
        'Wygrywa tylko ten, kto ma jasno określony cel <br />i nieodparte pragnienie, aby go osiągnąć.',
        'Napoleon Hill'
    ],
    [
        'Nigdy nie wzniesiesz się ponad to, <br />czemu nie chcesz spojrzeć w oczy.',
        'Anthony de Mello'
    ],
    [
    ...
    [
        'Do osiągnięcia kolejnego poziomu zawodowego i osobistego <br />niezbędny jest nowy wzorzec myślenia.',
        'Anthony Robbins'
    ],
    [
        'Liczy się nie tylko osiągnięcie celu, lecz także jakość życia,<br />której doświadczasz na drodze, która do celu prowadzi.',
        'Anthony Robbins'
    ],
    [
        'Jeśli chcesz wyleczyć nudę, rozwiń w sobie ciekawość.<br />Kiedy jesteś ciekawy, nic nie jest ani nudne, ani trudne.',
        'Anthony Robbins'
    ],
    [
        'Największym cierpieniem człowieka jest świadomość, <br />że żyje on poniżej poziomu własnych możliwości.',
        'Anthony Robbins'
    ],
    [
        'Tylko życie jest naprawdę ważne. Pamiętanie o tym, że kiedyś umrzesz jest najlepszym sposobem jaki znam na uniknięcie myślenia o tym, że masz cokolwiek do stracenia.',
        'Steve Jobs'
    ],
    [
        'Spędziłem większość życia, martwiąc się o rzeczy,<br />które nigdy się nie wydarzyły.',
        'Mark Twain'
    ],
    [
    ...
    [
        'Sposobem na zaczęcie jest skończenie mówienia<br />i podjęcie działania.',
        'Walt Disney'
    ],
    [
        'Ludzie, którzy nie mają problemów to ludzie martwi.<br />Dzień twojej śmierci będzie dniem bez problemów.',
        'Nikodem Marszałek'
    ],
    [
        'W życiu wielu ludzi wie, co robić, ale mało ludzi robi to, co wie…<br />Nie wystarczy tylko wiedzieć! Musisz podjąć działanie!',
        'Anthony Robbins'
    ],
    [
    ...
    [
        'Jeśli nie chcesz być zapomnianym szybko po śmierci, <br/ >albo zaraz pisz rzeczy warte przeczytania, <br/ >albo czyń rzeczy warte opisania.',
        'Benjamin Franklin'
    ],
    [
    ...
    [
        'Jesteś biedny i nieszczęśliwy nie dlatego, że Bóg tak chciał,<br />ale dlatego, że twój ojciec wpoił ci, że tak musi być.',
        'Henry Ford'
    ],
    [
    ...
    [
        'Jeśli uważasz, że coś potrafisz lub że czegoś nie potrafisz,<br />na pewno masz rację.',
        'Henry Ford'
    ],
    [
        'Nic nie jest szczególnie trudne do zrobienia,<br />jeśli tylko rozłożyć to na etapy.',
        'Henry Ford'
    ],
    [
        'Z chwilą, gdy ktoś popadnie w stan umysłowy „rzeczoznawcy”,<br />wiele rzeczy staje się niemożliwe.',
        'Henry Ford'
    ],
    [
